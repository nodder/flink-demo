...
import name.cdd.study.flink.demo.onesight.table.function.DiffWithExpiringFunction;
...
//滑动窗口，统计count，只输出变化的内容。变化的内容有超时时间限制。
...
public class OutputNonRepetitive3_hop_expiringtime
{
    public static void main(String[] args) throws Exception
    {
        ...
        tableEnv.registerFunction(DiffWithExpiringFunction.METHOD_NAME, new DiffWithExpiringFunction());
        ...
        String sql = "select custom_id, "
                     ...
                     + "from KafkaTable GROUP BY custom_id, "
                                      ...
                                      + "HAVING IS_DIFF_WITH_EXPIRING(count(custom_id), custom_id, HOP_PROCTIME(proctime, INTERVAL '5' SECOND, INTERVAL '20' SECOND), INTERVAL '20' SECOND)";
